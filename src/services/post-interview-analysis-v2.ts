    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="subtitle" style="font-size: 0.9em; margin-top: 10px;">
                Powered by Auxora • ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}
            </div>
        </div>
        ...
        <div class="section" style="text-align: center; padding-top: 40px; border-top: 2px solid var(--light-gray);">
            <p style="color: #7f8c8d; font-size: 0.9em;">
                Generated by <strong>Auxora V2</strong> • Powered by Claude Opus 4.5<br>
                For questions or support: founders@auxora.ai
            </p>
        </div>
    </div>
</body>
