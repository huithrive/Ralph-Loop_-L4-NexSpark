          ...
          <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:16px;align-items:start;">
            ...
            <div>
              ...
              <div style="display:flex;flex-direction:column;gap:9px;">
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$2,500</span></div><span style="font-size:13px;color:#7A6E65;">Strategy &amp; positioning</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$3,000</span></div><span style="font-size:13px;color:#7A6E65;">Landing page &amp; website</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$2,000</span></div><span style="font-size:13px;color:#7A6E65;">Ad creative production</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$1,500</span></div><span style="font-size:13px;color:#7A6E65;">Campaign setup &amp; launch</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$1,500</span></div><span style="font-size:13px;color:#7A6E65;">A/B testing setup</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#F0D8CE;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">$1,500</span></div><span style="font-size:13px;color:#7A6E65;">Email flows for LTV</span></div>
              </div>
              <div style="margin-top:14px;padding:10px 16px;background:#FDF2EE;border-radius:12px;border:1px solid #F0CEBE;">
                <div style="font-size:18px;font-weight:800;color:#BF6744;font-family:'Playfair Display',serif;">$12,000 total</div>
                <div style="font-size:11px;color:#A8A09A;margin-top:2px;">paid upfront · 30 days · no guarantee</div>
              </div>
            </div>
            ...
            <div>
              ...
              <div style="display:flex;flex-direction:column;gap:9px;">
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">$4.99</span></div><span style="font-size:13px;color:#3D4A38;">Strategy &amp; positioning</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">$99</span></div><span style="font-size:13px;color:#3D4A38;">Landing page &amp; website</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">$99</span></div><span style="font-size:13px;color:#3D4A38;">AI-generated ad creatives</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">incl.</span></div><span style="font-size:13px;color:#3D4A38;">Auto campaign setup &amp; launch</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">incl.</span></div><span style="font-size:13px;color:#3D4A38;">Automated A/B testing</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:#C8D8C2;display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#4A6741;font-weight:700;">incl.</span></div><span style="font-size:13px;color:#3D4A38;">Email &amp; LTV automation</span></div>
              </div>
              <div style="margin-top:14px;padding:10px 16px;background:#EEF3EC;border-radius:12px;border:1px solid #C8D8C2;">
                ...
                <div style="font-size:11px;color:#A8A09A;margin-top:2px;">pay as you go · cancel anytime</div>
              </div>
            </div>
