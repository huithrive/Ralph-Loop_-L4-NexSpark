...
<body>
  ...
  <section style="background:#1C1917;padding:72px 24px;">
    <div style="max-width:1060px;margin:0 auto;">
      ...
      <!-- Agency vs Auxora comparison — inline inside dark section -->
      <div style="margin-bottom:48px;">
        <div style="background:#252220;border:1px solid #3D3530;border-radius:24px;padding:36px;max-width:900px;margin:0 auto;">
          <p class="eyebrow" style="text-align:center;margin-bottom:28px;color:#7A6E65;">The same full service — done in 1 day, not 30</p>
          <div style="display:grid;grid-template-columns:1fr auto 1fr;gap:16px;align-items:start;">
            ...
            <div>
              ...
              <div style="display:flex;flex-direction:column;gap:9px;">
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">7 days</span></div><span style="font-size:13px;color:#7A6E65;">Strategy &amp; positioning</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">5 days</span></div><span style="font-size:13px;color:#7A6E65;">Landing page &amp; website</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">5 days</span></div><span style="font-size:13px;color:#7A6E65;">Ad creative production</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">5 days</span></div><span style="font-size:13px;color:#7A6E65;">Campaign setup &amp; launch</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">4 days</span></div><span style="font-size:13px;color:#7A6E65;">A/B testing setup</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(191,103,68,0.2);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#BF6744;font-weight:700;">4 days</span></div><span style="font-size:13px;color:#7A6E65;">Email flows for LTV</span></div>
              </div>
              <div style="margin-top:14px;padding:10px 16px;background:#1C1917;border-radius:12px;border:1px solid rgba(191,103,68,0.3);">
                <div style="font-size:18px;font-weight:800;color:#BF6744;font-family:'Playfair Display',serif;">30 days total</div>
                <div style="font-size:11px;color:#5A5040;margin-top:2px;">$12,000 · paid upfront · no guarantee</div>
              </div>
            </div>

            <!-- VS -->
            <div style="display:flex;flex-direction:column;align-items:center;padding:0 6px;">
              <div style="flex:1;width:1px;background:linear-gradient(to bottom,transparent,#3D3530);"></div>
              <div style="font-size:12px;font-weight:700;color:#FAF7F4;background:#3D3530;border:1.5px solid #5A5040;border-radius:100px;padding:5px 10px;margin:8px 0;">VS</div>
              <div style="flex:1;width:1px;background:linear-gradient(to bottom,#3D3530,transparent);"></div>
            </div>

            <!-- Auxora -->
            <div>
              <div style="font-size:11px;font-weight:700;color:#6E8B5E;letter-spacing:0.06em;text-transform:uppercase;margin-bottom:14px;">Auxora · 24 hours · $200</div>
              <div style="display:flex;flex-direction:column;gap:9px;">
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">2 hrs</span></div><span style="font-size:13px;color:#A8A09A;">Strategy &amp; positioning</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">4 hrs</span></div><span style="font-size:13px;color:#A8A09A;">Landing page &amp; website</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">3 hrs</span></div><span style="font-size:13px;color:#A8A09A;">AI-generated ad creatives</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">4 hrs</span></div><span style="font-size:13px;color:#A8A09A;">Auto campaign setup &amp; launch</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">3 hrs</span></div><span style="font-size:13px;color:#A8A09A;">Automated A/B testing</span></div>
                <div style="display:flex;align-items:center;gap:10px;"><div style="width:46px;height:22px;border-radius:100px;background:rgba(74,103,65,0.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;"><span style="font-size:8px;color:#6E8B5E;font-weight:700;">4 hrs</span></div><span style="font-size:13px;color:#A8A09A;">Email &amp; LTV automation</span></div>
              </div>
              <div style="margin-top:14px;padding:10px 16px;background:#1C1917;border-radius:12px;border:1px solid rgba(74,103,65,0.4);">
                <div style="font-size:18px;font-weight:800;color:#6E8B5E;font-family:'Playfair Display',serif;">24 hours total</div>
                <div style="font-size:11px;color:#5A5040;margin-top:2px;">$200 · pay as you go · cancel anytime</div>
              </div>
            </div>
