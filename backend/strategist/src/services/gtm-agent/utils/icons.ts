/**
 * Professional SVG Icons for GTM Reports
 * Replaces emoji icons with consistent, professional SVG graphics
 */
...
type ValidIconName = (typeof VALID_ICONS)[number];

export function getSvgIcon(name: string): string {
  const icons: Record<ValidIconName, string> = {
    ...
    map: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/></svg>`,
    ...
    flask: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 2v7.535a3 3 0 0 1-.879 2.122l-4.242 4.242A3 3 0 0 0 3 17.707V20a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2.293a3 3 0 0 0-.879-2.122l-4.242-4.242A3 3 0 0 1 15 9.535V2"/><path d="M9 2h6"/></svg>`,
    ...
    growth: `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"/></svg>`,
  };

  if (!VALID_ICONS.includes(name as ValidIconName)) {
    console.warn(`[GTM Report] Icon "${name}" not found, falling back to "chart" icon`);
    return icons.chart;
  }

  return icons[name as ValidIconName];
}
